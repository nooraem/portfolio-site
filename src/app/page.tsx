...
export default function Home() {
  return (
    <section className="max-w-3xl mx-auto text-center py-8 px-6 sm:py-20 ">
      <Image 
        src="/pfp.jpg" 
        width={128} 
        height={128} 
      ...
      <h1 className="text-4xl sm:text-5xl font-tinos mb-8 text-amaranth-purple">
      ...
      <Link
        href="/projects"
        className="text-tyrian-purple font-medium text-lg sm:text-xl transition"
      >
